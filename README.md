...
> Answer: The main benefit for client side routing is to make the webpage load faster. With client side routing, you are only updating the component that needs to be updated, not refreshing the whole page. This provides a much smoother UX and more porformant website. Allows for dynamic routing.
